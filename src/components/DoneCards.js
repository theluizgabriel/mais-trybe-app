  ...
  return (
    <div>
      {doneRecipes ? doneRecipes
        .map(({
          id, nationality, type, category, doneDate, image, name, tags, alcoholicOrNot,
        }, index) => (
          <div key={ index } className="doneRecipe">
            ...
            <div className="items-list">
              <div className="head-done">
                ...
                >
                  {type === 'food'
                    ? <p>{`${nationality} - ${category}`}</p> : <p>{alcoholicOrNot}</p>}
                </div>
                <input
                  type="image"
                  className="share-btn"
              ...
              {index === messageIndex
                ? <span hidden={ !message }> Link copied! </span> : ''}
